...
$whatsapp_url = 'https://jedaidevbed.in/zedaid';
...
<a href="https://zedaid.org/i-need/" id="okapi-wasb-button" target="_blank">
	<img id="okapi-wasb-icon" src="<?php echo $icon_src; ?>" class="frame"> 
</a>