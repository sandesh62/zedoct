...
<footer class="footer-wrapper">
    <div class="container">
        ...
        <div class="footer-col box2">
            <h2 class="section-title">Lidhjet e Shpejta
</h2>
            <ul class="quick-links-list">
                <li><a href="<?= BASE_URL; ?>"><i class="fa fa-angle-right "></i>Shtëpi</a></li>
                <li><a href="<?= BASE_URL; ?>before-hair-transplant-operation/"><i class="fa fa-angle-right "></i>Para & Pas
</a></li>
                <li><a href="<?= BASE_URL; ?>packages-and-services/fue-hair-transplant/"><i class="fa fa-angle-right "></i>Zafir mikro FUE
                ...
                <li><a href="<?= BASE_URL; ?>about-us/"><i class="fa fa-angle-right "></i>Rreth nesh
</a></li>
                ...
                <li><a href="<?= BASE_URL; ?>experience/"><i class="fa fa-angle-right "></i>Përvoja</a></li>
                <li><a href="<?= BASE_URL; ?>contact-us/"><i class="fa fa-angle-right "></i>Na kontaktoni
</a></li>
            </ul>
        </div>
        <div class="footer-col box3">
            <p>Të gjitha procedurat përfundojnë në një strukturë të akredituar JCI dhe mbrohen nga garancia jonë e artë për jetën
</p>
            <ul class="bagde-list">
                <li>
