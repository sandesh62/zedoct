                    ...
                    <form id="regestartionForm" method="post" class="tp-accountWrapper" action="">
                        ...
                        <div class="tp-accountForm form-style">
                            ...
                            <div class="fromTitle">
                                ...
                                <p>Register into Zedaid Foundation</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-12">
                                    ...
                                    <input value="<?= $_POST['first_name'] ? $_POST['first_name'] : ''; ?>" required type="text" id="first_name" name="first_name" placeholder="Your first name here..">
                                ...
                                <div class="col-lg-12 col-md-12 col-12">
                                    ...
                                    <input value="<?= $_POST['last_name'] ? $_POST['last_name'] : ''; ?>" required type="text" id="last_name" name="last_name" placeholder="Your last name here..">
                                ...
                                <div class="col-lg-12 col-md-12 col-12">
                                    ...
                                    <input value="<?= $_POST['phoneNumber'] ? $_POST['phoneNumber'] : ''; ?>" required type="text" id="phoneNumber" name="phoneNumber" class="num" placeholder="Your phone number here..">
