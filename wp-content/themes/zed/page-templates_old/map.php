            ...
            <div class="container">
                <div class="row">
                    <div class="widget search-widget ">
                        <form>
                            <div>
                                <input type="text" class="form-control serach locationtextbox" placeholder="Enter address here" name="location" id="location">
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="tp-blog-sidebar">
                            <div class="widget category-widget">
                                <ul>
                                    <li class="bor"><a onclick="camptypeid(1)" href="javascript:void(0)"><input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">Fundraiser</a></li>
                                    <li class="bor"><a onclick="camptypeid(2)" href="javascript:void(0)"><input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">Material donation</a></li>
                                    <li class="bor"><a onclick="camptypeid(3)" href="javascript:void(0)"><input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">Marketplace for charity products</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                for (i = 0; i < locations.length; i++) {
                                    ...
                                    if (locations[i][3] == 1) {
                                        marker = new google.maps.Marker({
                                            ...
                                            icon: '<?= BASE_URL ?>/wp-content/uploads/2021/06/marker_fundraise.png',
                                            map: map
                                        });
                                    } else if (locations[i][3] == 2) {
                                        marker = new google.maps.Marker({
                                            position: new google.maps.LatLng(locations[i][1], locations[i][2]),
                                            icon: '<?= BASE_URL ?>/wp-content/uploads/2021/06/marker_material-2.png',
                                            map: map
                                        });
