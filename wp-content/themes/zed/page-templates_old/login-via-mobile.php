...
<head>
    ...
    <title>Login Via Mobile | Zed</title>
                    ...
                    <form id="loginmobileForm" method="post" class="tp-accountWrapper" action="">
                        ...
                        <div class="tp-accountForm form-style">
                            <div class="fromTitle">
                                ...
                                <p>Login Via Mobile into Zedaid Foundation</p>
                            </div>
                            <?php
                            if (isset($errors)) {
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-12">
                                    ...
                                    <input value="<?= $_POST['phoneNumber'] ? $_POST['phoneNumber'] : ''; ?>" type="text" id="phoneNumber" name="phoneNumber" placeholder="Your phone number here.." class="num">
                                </div>



                                <div class="col-lg-12 col-md-12 col-12">
                                    <button type="submit" class="tp-accountBtn">Login Via Mobile</button>
                                </div>
                            </div>
