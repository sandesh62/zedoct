    ...
    <section class="tp-blog-single-section section-pad" style="background: #eee;">
      <div class="container">
        ...
        <div class="col-lg-12 regform" >
          <h1>Edit Campaign</h1>
          <form id="regform" method="post" class="tp-accountWrapper" action="<?=BASE_URL?>editcamp.php" novalidate="novalidate" enctype="multipart/form-data">
          ...
          <input type="hidden" id="userId" name="userId" value="<?php echo $user->data->ID; ?>" >
            <script>
