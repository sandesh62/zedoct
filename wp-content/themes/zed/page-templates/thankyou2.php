...
<body>
  ...
  global $wpdb;
  $id = $_GET['id'];
  $results = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}campaignsedit WHERE update_status = 0 AND campaignedit_id =" . $id, OBJECT);
  $res = $results[0];
          ...
          <div class="col col-md-12" style="text-align: center;">
            <div class="tp-case-details-wrap">
              <div class="tp-case-details-text">                
                ...
                <h2 style="text-align: center;margin-top:5px;margin-bottom: 20px;">Your Update Request Is Under Review!</h2>
                  ...
                  <div class="tp-case-content">
                    ...
                    <p>Your update request will be approved in 24 hours</p>
                  </div>

                  <a href="<?= BASE_URL; ?>my-account/" class="button1thanks">Go To Dashboard</a>
