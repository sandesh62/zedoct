...
<meta property="og:url" content="https://zedaid.org" />
<meta property="og:title" content="ZED – CrowdSourcing Platform" />
...
<meta property="og:image" content="https://zedaid.org/wp-content/themes/zed/images/zed.png" />
...
<section class="blog-section home-section-padding">
    <div class="container">
        ...
        <div class="row">
            ...
            if(count($resultsdonaccxe) == 3){
            ?>
                <div class="col-md-12">
            <?php } else if(count($resultsdonaccxe) == 2){ ?>
            ...
            <?php } ?>
                ...
                <div class="blog-grids clearfix evecenter1">
                    ...
                    foreach ($resultsdonaccxe as $eve) {
                        ...
                        $dates = date('dS M Y', strtotime($eve->event_date));  //get_the_date('dS M Y', $eve['ID']);
                        ?>
                        <div class="grid" onclick="window.location.href='<?= BASE_URL . 'event/'.$eve->post_name; ?>'">
                            <div class="entry-media">
                                <img width="360" height="750" src="<?php echo $featured_img_url; ?>" alt="" style="height: 360px !important;" />
                            </div>
                            <div class="details">
                                <h3>
