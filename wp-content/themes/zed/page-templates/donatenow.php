                ...
                <div class="col-lg-12">
                    ...
                    <form class="tp-accountWrapper" id="frmDonation" method="post" action="<?php echo BASE_URL; ?>submitdonate2.php">
                        ...
                        <div class="tp-accountForm form-style">
                            ...
                            <div class="row">
                                <div class=""></div>
                                <div class="col-lg-12 col-md-12 col-12 hr padleft">
                                    <input type="text" id="fullName" name="fullName" placeholder="Enter Full Name" class="hr-top" maxlength="50">
                                </div>
                                <div class="col-lg-12 col-md-12 col-12">
                                    <input type="checkbox" id="anonymous" name="anonymous" value="1">
                                    <label style="margin-left:25px;" class="mar" for="anonymous">Anonymous</label>
                                </div>
                                <div class="col-lg-12 col-md-12 col-12 padleft">
                                ...
                                <div class="col-lg-3 col-md-12 col-12 col-sm-3 padleft">
                                ...
                                <div class="col-lg-12 col-md-12 col-12">
                                    ...
                                    <label style="margin-left:25px;" class="mar" for="payment_type">Offline Payment</label>
                                </div>
                                <?php } else {?>
