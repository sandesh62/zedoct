...
error_reporting(0);
/**
 * Template Name: Campaign Listing Admin
 *
 * @package WordPress
                            ...
                            <div class="widget category-widget">
                                <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                            <img src="<?= BASE_URL?>/fundraiserimg/<?= $val['image'];?>" width="50">
                                            </td>
                                            <td>
                                            <?= $val['fundraiser_title'];?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                            <span class="licause"><a href="<?= BASE_URL?>campaign-detail-admin-2/?id=<?= $val['id'];?>">View Details</a></span>
                                            </td>
                                        </tr>
                                        <?php } ?>
