                        ...
                        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                            ...
                            if (0 === count($errors)) {
                                ...
                                if (isset($_POST['new_password']) && !empty($_POST['new_password'])) {
                                    ...
                                    /* $userdata['ID'] = $new_user_id; //user ID
                                ...
                                $success = 1;
                                header("Location: " . BASE_URL . 'my-profile/?save=1');
                            }
                        }
                        ?>
                        <?php
                            ...
                            <div class="row gutters ">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <input type="text" value="<?= $_POST['first_name'] ? $_POST['first_name'] : $first_name; ?>" class="form-control" id="first_name" name="first_name" placeholder="Enter First Name" maxlength="50">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <input type="text" value="<?= $_POST['last_name'] ? $_POST['last_name'] : $last_name; ?>" class="form-control" id="last_name" name="last_name" placeholder="Enter Last Name" maxlength="50">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <!-- <div class="form-group">
