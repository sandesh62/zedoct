<?php
/**
 * Template Name: Update-Detail-Admin
 *
 * @package WordPress
...
<body>
  ...
  $id = $result[0];
  $results = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}campaignsedit WHERE admin_approved = 1 AND update_status = 0 AND campaignedit_id =" . $id, OBJECT);
  $res = $results[0];
