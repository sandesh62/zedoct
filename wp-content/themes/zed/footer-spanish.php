...
<footer class="footer-wrapper">
    <div class="container">
        ...
        <div class="footer-col box2">
            <h2 class="section-title">enlaces rápidos
</h2>
            <ul class="quick-links-list">
                <li><a href="<?= BASE_URL; ?>"><i class="fa fa-angle-right "></i>Casa
</a></li>
                <li><a href="<?= BASE_URL; ?>before-hair-transplant-operation/"><i class="fa fa-angle-right "></i>Antes después
</a></li>
                <li><a href="<?= BASE_URL; ?>packages-and-services/fue-hair-transplant/"><i class="fa fa-angle-right "></i>Zafiro Micro FUE

                    </a></li>
                <li><a href="<?= BASE_URL; ?>our-media/"><i class="fa fa-angle-right "></i>Videos</a></li>
                <li><a href="<?= BASE_URL; ?>packages-and-services/dhi-hair-transplant/"><i class="fa fa-angle-right "></i>Pluma DHI Choi
</a></li>
                <li><a href="<?= BASE_URL; ?>about-us/"><i class="fa fa-angle-right "></i>Sobre nosotras</a></li>
                ...
                <li><a href="<?= BASE_URL; ?>press-and-award/"><i class="fa fa-angle-right "></i>Medios de comunicación
</a></li>
                <li><a href="<?= BASE_URL; ?>experience/"><i class="fa fa-angle-right "></i>Experiencia
</a></li>
                <li><a href="<?= BASE_URL; ?>contact-us/"><i class="fa fa-angle-right "></i>Contacta con nosotras</a></li>
            </ul>
        </div>
        <div class="footer-col box3">
            <p>Todos los procedimientos se completan en una instalación acreditada por la JCI y están protegidos por nuestra garantía de oro de por vida.
</p>
            <ul class="bagde-list">
                <li>
