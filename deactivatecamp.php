...
$subjectnn = "ZED$campaign_id - $campt - $fundtitle - $res->address - Has been  by ZedAid, you can track the progress at : $detaillink";

$to = $user_email;
$subject = "ZED$campaign_id - $campt - $fundtitle - $address - Has been deactivated";
...
$file = 'email/camp_deactivated.html';    
...
$smstext = 'Dear '.$display_name.', your campaign is approved by ZedAid. Start sharing the campaign with donors. '.$detaillink;
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_POSTFIELDS => "{\"sender\":\"JEDAII\",\"route\":\"4\",\"country\":\"91\",\"DLT_TE_ID\":\"1307162620980005462\",\"sms\":[{\"message\":\"$smstext\",\"to\":[\"$phone\"]}]}",
