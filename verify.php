...
if ($success === true) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_POSTFIELDS => "{\"sender\":\"JEDAII\",\"route\":\"4\",\"country\":\"91\",\"DLT_TE_ID\":\"1307163394052658821\",\"sms\":[{\"message\":\You have got one donation on ZedAid campaign $fundtitle.\",\"to\":[\"$meta_valuephone\"]}]}",
    ...
    curl_setopt_array($curl2, array(
        ...
        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
        CURLOPT_CUSTOMREQUEST => "POST",
        CURLOPT_POSTFIELDS => "{\"sender\":\"JEDAII\",\"route\":\"4\",\"country\":\"91\",\"DLT_TE_ID\":\"1307163394059407777\",\"sms\":[{\"message\":\"ZedAid got one donation on Campaign $fundtitle.\",\"to\":[\"$phone2\"]}]}",
        CURLOPT_HTTPHEADER => array(
            "authkey: 328268AKM9eIBEQ5eb00746P1",
            "cache-control: no-cache",
            "content-type: application/json",
    ...
    $html = '<table style="background-color: #fff; color: #222;padding-top:30px;" cellpadding="10" >
    <tbody>
    <tr>
    ...
    $html .= '<br><br>';
    $html .= '
    <table cellpadding="10" border="1" align="center" width="98%" style="margin-right:10px;">
    <tbody>
    <tr>
    <td style="width:70%;text-align:left">Donation Amount</td>
    <td style="width:30%;text-align:right">INR '.$amount.'</td>
    </tr>
    <tr>
    <td style="width:70%;text-align:left">Convenience Fee</td>
    <td style="width:30%;text-align:right">INR 0</td>
    </tr>
    <tr>
    <td style="width:70%;text-align:left">GST</td>
    <td style="width:30%;text-align:right">INR 0</td>
    </tr>
    <tr>
    <td style="width:70%;text-align:left;background-color:#C0C0D9;">Total</td>
    <td style="width:30%;background-color:#C0C0D9;text-align:right">INR '.$amount.'</td>
    </tr>
    </tbody>
    </table>';
    $html .= '<br><br>';
    ...
    Dear Donar , please find attached the donation receipt and the payment will reflect online in next 48 hrs.
    </td>
    </tr>
    </tbody>
    </table>';
    ...
    $file_name = 'Reciept_'.rand('1111','9999').time().'.pdf';
