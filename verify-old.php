...
$conn->query("INSERT INTO wp_logs SET module = 'payment', response = '".json_encode($payment)."'");
...
$sqllog = "INSERT INTO wp_logs (module,request,response) VALUES ('RazorPayment_Success','" . $razorpay_payment_id . "','".json_encode($payment)."')";
$conn->query($sqllog);
...
if ($success === true) {
    ...
    if ($conn->query($sqli) === TRUE) {
      ...
      $sql_update = "UPDATE wp_campaigndonations SET invoice_id = '".$invoice_id."' WHERE id = '".$last_id."'";
    ...
    This is not an invoice but only a confirmation of the receipt of the amount paid against for the service as described above. Subject to terms and conditions mentioned at razorpay.com
    </td>
    </tr>
    </tbody>
    </table>';
