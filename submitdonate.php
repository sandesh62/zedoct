...
$phone2 = '9892489040';
if ($res->campaign_typeId == 3) {
    $smstextAdmin = 'ZedAid got one donation request on Campaign '.$fundtitle;
}else{
    $smstextAdmin = 'ZedAid got one donation request on Campaign '.$fundtitle;
}
$curl2 = curl_init();
...
curl_setopt_array($curl2, array(
    ...
    CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
    CURLOPT_CUSTOMREQUEST => "POST",
    CURLOPT_POSTFIELDS => "{\"sender\":\"JEDAII\",\"route\":\"4\",\"country\":\"91\",\"DLT_TE_ID\":\"1307163394041208762\",\"sms\":[{\"message\":\"$smstextAdmin\",\"to\":[\"$phone2\"]}]}",
    CURLOPT_HTTPHEADER => array(
        "authkey: 328268AKM9eIBEQ5eb00746P1",
        "cache-control: no-cache",
        "content-type: application/json",
